...
import { searchSealed, sealedImage, sealedPrefill } from './sealed.js?v=2.3.2';
import { getCard, getSetCards, searchCards, priceVariants, links, tcgLang, cardImage, server } from './api.js?v=2.3.2';
import { settings } from './settings.js?v=2.3.2';
import { renderChart } from './chart.js?v=2.3.2';
...
export function openDetail(kind, id) {
  ...
  sheet.body.addEventListener('click', async (e) => {
    ...
    if ('invest' in t.dataset) import('./views/invest.js?v=2.3.2').then((mod) => mod.openInvest(kind, id));
